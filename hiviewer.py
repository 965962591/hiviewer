...
from src.utils.Custom_dialog_class import Qualcom_Dialog  # 导入自定义对话框的类
from src.utils.Custom_Font_class import SingleFontManager, MultiFontManager  # 字体管理器
    ...
    def on_ctrl_h_pressed(self):
        ...
        try:
            ...
            if not hasattr(self, 'help_dialog'):
                ...
                markdown_path = os.path.join(doc_dir, "update_main_logs.md")
