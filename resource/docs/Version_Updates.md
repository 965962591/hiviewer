...
1. 优化压缩文件逻辑，支持按照文件夹层级进行压缩并粘贴到剪贴板
2. 优化一些已知bug


### V3.6.3-2025.09.15

1. 代码重构，优化异常抛出逻辑，提高程序鲁棒性
2. 重构批量重命功能，优化底层代码逻辑
3. 重构脚本管理器，支持批量执行adb命令以及一键批量导图等功能

### V3.6.2-2025.09.03

1. 添加本工具Log信息写入功能，方便debug报错信息，主界面使用F3键快速调出
2. 主界面新增功能项，支持跨父文件夹添加到表格中进行比较
3. 修复看图子界面q/w覆盖后图片会会下移的bug

### V3.5.9-2025.08.07

1. 修改检测aebox程序逻辑，与aebox(高通、MTK)工具联动
2. 优化fast api功能，默认关闭，与aebox通信需要手动开启然后配置地址和端口
3. 重新设计底部栏的图标项
4. 修复与aebox通信时未正确匹配图片时仍会切图的bug
5. 添加对高通、MTK以及展锐平台图片进行解析以及EXIF信息显示功能
...
1. 修复看图子界面无法显示灰度图的bug
2. 添加看图子界面设置页，支持修改exif等显示信息
3. 修复其它一些已知bug

### V3.5.5-2025.07.16

1. 修复视频播放界面，标题显示不到首字符的bug
2. 修复主界面加载同级文件夹卡顿问题
3. 修复一些已知bug
...
2. 修复看图子界面问题点记录表格功能和拼接图功能，看图子界面按键T触发
3. 修复主界面看图移动步长逻辑（感谢祖文凯反馈相关bug）
