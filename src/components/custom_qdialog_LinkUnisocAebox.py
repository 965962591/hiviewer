...
class Unisoc_Dialog(QDialog):
    ...
    def setShortcut(self):
        ...
        self.load_button.clicked.connect(self.load_unisoc_path)         
    ...
    def get_url(self):
        ...
        # 高通工具路径url
        unisoc_path = self.text_input1.text()
        if unisoc_path and os.path.exists(unisoc_path):
            # url编码
            unisoc_path_encoded = urlencode_folder_path(unisoc_path)
            unisoc_path_url = f"http://127.0.0.1:8000/set_c7_path/{unisoc_path_encoded}"
        else:
            return []
    ...
    def save_settings(self):
        ...
        try:
            ...
            print("Unisoc_Dialog类_配置已保存")
        except Exception as e:
            print(f"Unisoc_Dialog类_保存配置失败: {e}")
