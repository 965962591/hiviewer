...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_5 = QtWidgets.QCheckBox(self.Sub_window)
        self.checkBox_5.setObjectName("checkBox_5")
        self.checkBox_5.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        self.hl_top.addWidget(self.checkBox_5)
