...
from PyQt5.QtGui import QImage, QPixmap, QCursor, QKeySequence, QIcon, QMovie
from PyQt5.QtWidgets import (
    QApplication, QWidget, QLabel, QPushButton, QProgressDialog,
    QHBoxLayout, QVBoxLayout, QSlider, QFileDialog, QComboBox, QMenu, QAction, 
    QSpinBox, QScrollArea, QSizePolicy, QDoubleSpinBox, QGridLayout, QShortcut,QMessageBox)
...
class VideoPlayer(QWidget):
    ...
    def init_ui(self):
        ...
        play_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "play.ico"))
        ...
        replay_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "replay.ico"))
        ...
        rotate_left_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "left.ico"))
        ...
        rotate_right_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "right.ico"))
        ...
        main_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "base.ico"))
    ...
    def play_pause(self):
        if self.is_paused:
            ...
            pause_icon_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "pause.ico"))
    ...
    def set_as_baseline(self):
        ...
        # 路径
        gif_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "icons", "ncat.gif"))
