...
![Alt text](D:\Image_process\hiviewer-master\documentation\image.png)
...
![Alt text](D:\Image_process\hiviewer-master\documentation\image-1.png)

2.在主界面选中视频文件时，除了按下SPACE/B键打开视频，还可以按下对比按钮打开视频文件

3.在视频播放子界面，每个视频底下会显示单个视频的进度条和控制按钮（播放速度、跳帧设置，查找相似帧、暂停，从头播放、左旋转90度、右旋转90度）

![Alt text](D:\Image_process\hiviewer-master\documentation\image-2.png)
...
![Alt text](D:\Image_process\hiviewer-master\documentation\image-3.png)

2.在命名规则下拉框中，预置了常见的规则，选择命名规则后，可以点击预览查看是否符合预期，然后点击开始按钮，即可对文件进行重命名

![Alt text](D:\Image_process\hiviewer-master\documentation\image-4.png)

3.查看替换复选框的使用，具体操作如下图，可以替换文件名中的指定字符

![Alt text](D:\Image_process\hiviewer-master\documentation\image-5.png)
...
![Alt text](D:\Image_process\hiviewer-master\documentation\image-6.png)
...
![Alt text](D:\Image_process\hiviewer-master\documentation\image-7.png)
